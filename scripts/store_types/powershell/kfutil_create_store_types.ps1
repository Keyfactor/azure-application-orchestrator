...
& kfutil store-types create --name "AzureApp"
& kfutil store-types create --name "AzureSP"
& kfutil store-types create --name "AzureApp2"
& kfutil store-types create --name "AzureSP2"
